...
namespace Bynder.Sdk.Service.Upload
{
    ...
    internal class FileUploader
    {
        ...
        public FileUploader(IApiRequestSender requestSender, IFileSystem fileSystem, int chunkSize)
        {
        ...
        public FileUploader(IApiRequestSender requestSender) : this(
            requestSender,
        ...
        public async Task<SaveMediaResponse> UploadFileToNewAssetAsync(string path, string brandId)
        {
