...
namespace Bynder.Sdk.Api.RequestSender
{
    ...
    internal class ApiRequestSender : IApiRequestSender
    {
        ...
        {
            var uriBuilder = new UriBuilder(_configuration.BaseUrl.ToString()).AppendPath(request.Path);
            ...
            var httpRequest = new HttpRequestMessage(request.HTTPMethod, uriBuilder.ToString());
