...
namespace Bynder.Test.Service.OAuth
{
    public class OAuthServiceTest
    {
        ...
        public void GetAuthorisationUrlReturnsCorrectUrl()
        {
            ...
            Assert.Equal("https://example.bynder.com:443/v6/authentication/oauth2/auth?client_id=clientId&redirect_uri=https%3A%2F%2Fredirect.bynder.com&scope=openid%20offline&response_type=code&scope=openid%20offline&state=state%20example",
                authorisationUrl);
        }
